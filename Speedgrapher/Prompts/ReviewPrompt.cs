...
3.  **Summary of Required Changes:** A bulleted list of the most critical changes the author needs to make to meet the guidelines.";
    ...
    /// <summary>
    /// Sets the path to the editorial guidelines file.
    /// </summary>
    ...
    [McpServerPrompt(Name = "review"), Description("Reviews the article currently being worked on against the editorial guidelines.")]
    public static IList<PromptMessage> GetReview()
    {
        var guidelines = DefaultReviewText;
        ...
        var prompt = "Please review the work-in-progress article currently in your context against the provided editorial guidelines.";

...
If I have provided a specific hint, prioritize that area. Otherwise, use your expertise to identify which parts of the draft are too thin and need this deeper work.";
    ...
    [McpServerPrompt(Name = "expand"), Description("Expands a working outline or draft into a more detailed article.")]
    public static IList<PromptMessage> GetExpand(
        [Description("An optional hint to guide the expansion.")] string? hint = null)
    {
        var prompt = ExpandText;
